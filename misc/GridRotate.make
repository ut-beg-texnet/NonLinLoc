...
GridRotate : ${BINDIR}/GridRotate
${BINDIR}/GridRotate : GridRotate.o ${OBJS1}
	gcc GridRotate.o ${OBJS1} ${CCFLAGS} -o ${BINDIR}/GridRotate -lm
GridRotate.o : GridRotate.c GridLib.h
	gcc -c ${CCFLAGS} GridRotate.c
# --------------------------------------------------------------------------

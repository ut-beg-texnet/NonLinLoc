...
#
OBJS1=${GRID_LIB_OBJS}
GridReplaceValue : ${BINDIR}/GridReplaceValue
${BINDIR}/GridReplaceValue : GridReplaceValue.o ${OBJS1}
	gcc GridReplaceValue.o ${OBJS1} ${CCFLAGS} -o ${BINDIR}/GridReplaceValue -lm
GridReplaceValue.o : GridReplaceValue.c GridLib.h
	gcc -c ${CCFLAGS} GridReplaceValue.c
# --------------------------------------------------------------------------
